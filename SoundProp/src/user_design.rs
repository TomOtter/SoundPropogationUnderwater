...
impl Simulation {
    ...
    pub fn output(&mut self, xdata: Vec<Vec<f64>>, ydata: Vec<Vec<f64>>) {
...
impl Source {
    pub fn initialise(source_type: Source_Type, min_angle: f64, max_angle: f64,
